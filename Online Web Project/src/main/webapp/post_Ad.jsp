               ...
               <!-- ad post form-->
                <form action="PostAd" method="post" enctype="multipart/form-data">
                    <table style="color:black;" >
                        <tr><td><h3>Post Ad</h3></td></tr>
                        <tr><td>Title</td>
                            <td><input value="${title}" type="text" name="title" style="width:300px; height:30px" class="w3-round w3-border " required="required"/></td>
                        </tr>
                        <tr><td>Price</td>
                            <td><input value="${price}" type="number" name="price" style="width:300px; height:30px" class="w3-round w3-border " required="required"/></td>
                        </tr>
                        <tr><td>Type</td>
                        ...
                        <tr><td>Image</td>
                            <td><input type="file" name="file" id="file" accept="image/*" class="w3-round w3-border" style="width:300px; height:50px; background-imag: url('imageURL/1.jpg')"></td
                        </tr>
                        <tr><td>Location</td>
                        ...
                        <tr>
                            ...
                            <td><input id="postButton" style="width:150px;" class="w3-btn w3-blue-grey" type="submit" value="Post Ad" /></td>
